        ...
        <div className="container mx-auto px-4 pt-8">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="prose prose-lg prose-invert">
                    <p className="mb-6">
                        Welcome to my personal website. Here you&apos;ll find my
                        thoughts and experiences in software engineering and
                        technology.
                    </p>
                    <div className="mb-12">
                        <Link
                            href="/writings"
                            className="text-lg text-blue-500 hover:text-blue-600 underline underline-offset-2"
                        >
